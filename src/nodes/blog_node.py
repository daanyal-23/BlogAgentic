...
class BlogNode:
    ...
    def translation(self,state:BlogState):
        ...
        Provide the translated title and content in JSON format with keys 'title' and 'content'.
        """
        ...
        try:
            ...
            return {"blog": {"title": translated_data["title"], "content": translated_data["content"]}}
        except:
            # Fallback: assume the content is the translated text
            return {"blog": {"title": state["blog"]["title"], "content": response.content}}
